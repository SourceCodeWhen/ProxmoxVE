...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/SourceCodeWhen/ProxmoxVE/paperless-ngx-testingmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-container.sh)"
